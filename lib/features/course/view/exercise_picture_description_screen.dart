...
class ExerciseMultipleChoiceScreen extends StatefulWidget {
  final String exerciseId;
  const ExerciseMultipleChoiceScreen({super.key, required this.exerciseId});

  @override
  State<ExerciseMultipleChoiceScreen> createState() => _ExerciseMultipleChoiceScreenState();
}

class _ExerciseMultipleChoiceScreenState extends State<ExerciseMultipleChoiceScreen> {
  ...
  // NEW: Chỉ giữ lại 2 expandable sections
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // NEW: Ảnh minh hoạ (nếu có) - BÂY GIỜ Ở DƯỚI
                        ...
                        child: Image.network(
                          ...
                          loadingBuilder: (context, child, progress) {
                            ...
                            return Container(
                              ...
                              child: const Center(child: CircularProgressIndicator(strokeWidth: 2, color: Colors.deepPurple)),
                            );
                          },
                  ...
                  // NEW: Text hướng dẫn trong card nhẹ - SAU HÌNH ẢNH
                  ...
                  // NEW: Expandable "Gợi ý mô tả" - GIỮ NGUYÊN
                  ...
                  // NEW: Expandable "Đáp án tham khảo" - GIỮ NGUYÊN
