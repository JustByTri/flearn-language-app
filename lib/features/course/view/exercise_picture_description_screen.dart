...
class ExerciseMultipleChoiceScreen extends StatefulWidget {
  final Exercise exercise; // nhận từ list
  const ExerciseMultipleChoiceScreen({super.key, required this.exercise});
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ex.title.isNotEmpty ? ex.title : 'Mô tả bức tranh',
                    ...
                    Wrap(
                      ...
                      runSpacing: 6,
                      children: [
                        _chip(Icons.image_outlined, 'Mô tả tranh', Colors.deepPurple),
              ...
              if (ex.content.isNotEmpty && ex.content != 'string') ...[
                _sectionCard(title: 'Gợi ý mô tả', content: ex.content),
                const SizedBox(height: 12),
              ],
