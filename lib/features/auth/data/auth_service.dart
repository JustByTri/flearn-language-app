...
class AuthService implements IAuthRepository {
  ...
  Future<LoginResponse> login(LoginRequest request) async {
    ...
    try {
      print(
        " Login request: ${jsonEncode(request.toJson())}",
      );
      ...
      if (response.statusCode == 200) {
        ...
        print(
          "LoginResponse parsed: isSuccess=${loginResponse.isSuccess}, result=${loginResponse.result}",
        );
  ...
  Future<LoginResponse> register(
    ...
    try {
      ...
      print(
        " Register request: ${jsonEncode(registerRequest)}",
      );
      ...
      if (response.statusCode == 200) {
        ...
        print(
          " RegisterResponse parsed: isSuccess=${registerResponse.isSuccess}, result=${registerResponse.result}",
        );
  ...
  Future<LoginResponse> confirmEmail(String otp) async {
    ...
    final url = Uri.parse(
      '${ApiConfig.baseUrl}${ApiConfig.confirmEmailUrl}',
    );
  ...
  Future<LoginResponse> resendOtp(String email) async {
    final url = Uri.parse(
      '${ApiConfig.baseUrl}${ApiConfig.resendOtpUrl}',
    );
  ...
  Future<ResponseModel<User>> fetchProfile() async {
    ...
    final url = Uri.parse(
      '${ApiConfig.baseUrl}${ApiConfig.profileUrl}',
    );
    try {
